...
if __name__ == '__main__':
    ...
    output_file.write("img.icon\n")
    output_file.write("{\n")
    output_file.write("    aspect - ratio: 1;\n")
    output_file.write("    width: 64px;\n")
    output_file.write("    height: 64px;\n")
    output_file.write("    background-color: white;\n")
    output_file.write("    box-shadow: 0 4px 8px 0 rgba(0, 0, 0, 0.2), 0 6px 20px 0 rgba(0, 0, 0, 0.19);\n")
    output_file.write("    border: 1px solid #ddd;\n")
    output_file.write("    border-radius: 4px;\n")
    output_file.write("    padding: 4px;\n")
    output_file.write("}\n")
    output_file.write("td.pic\n")
    output_file.write("{\n")
    output_file.write("    width: 80px;\n")
    output_file.write("    text-align: center;\n")
    output_file.write("    vertical-align: top;\n")
    output_file.write("    padding-top: 10px;\n")
    output_file.write("    padding-bottom: 10px;\n")
    output_file.write("    padding-left: 0px;\n")
    output_file.write("    padding-right: 0px;\n")
    output_file.write("}\n")
    output_file.write("td.text\n")
    output_file.write("{\n")
    output_file.write("    width: 470px;\n")
    output_file.write("    text-align: left;\n")
    output_file.write("    vertical-align: top;\n")
    output_file.write("    padding-top: 10px;\n")
    output_file.write("    padding-bottom: 10px;\n")
    output_file.write("    padding-left: 10px;\n")
    output_file.write("    padding-right: 0px;\n")
    output_file.write("}\n")
    output_file.write("table.pubs\n")
    output_file.write("{\n")
    output_file.write("    border: none;\n")
    output_file.write("    width: 550px;\n")
    output_file.write("    margin-left: auto;\n")
    output_file.write("    margin-right: auto;\n")
    output_file.write("}\n")
    output_file.write("a.link_button {\n")
    output_file.write("    background-color: #e5e5e5;\n")
    output_file.write("    border: 1px solid #267CB9;\n")
    output_file.write("    border-radius: 4px;\n")
    output_file.write("    color: #267CB9;\n")
    output_file.write("    padding-top: 0px;\n")
    output_file.write("    padding-bottom: 0px;\n")
    output_file.write("    padding-left: 2px;\n")
    output_file.write("    padding-right: 2px;\n")
    output_file.write("    text-decoration: none;\n")
    output_file.write("    transition-duration: 0.4s;\n")
    output_file.write("    box-shadow: 0 8px 16px 0 rgba(0,0,0,0.2), 0 6px 20px 0 rgba(0,0,0,0.19);\n")
    output_file.write("}\n")
    output_file.write("a.link_button:hover {\n")
    output_file.write("    background-color: #069;\n")
    output_file.write("    color: #e5e5e5;\n")
    output_file.write("}\n")
    output_file.write("</style>\n")
